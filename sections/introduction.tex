...
The problem formulation and paper positioning are stable. Section~\ref{sec:theory} establishes a FIFO-indexed global upper bound under the stated model assumptions. Exhaustive evaluation of the sharpened bound and the remaining large-scale computational experiments are in progress. The derivation and audit record are preserved under \texttt{notes/}.
