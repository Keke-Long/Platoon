...
\end{equation}
Furthermore, this bound dominates the index-free bound
\begin{equation}
B_{\mathrm{idx}}(\Pi)
\le
B_0(\Pi)
...
Finally, \(0<\alpha_e<1\), so termwise monotonicity proves
\(B_{\mathrm{idx}}(\Pi)\le B_0(\Pi)\).
\end{proof}
