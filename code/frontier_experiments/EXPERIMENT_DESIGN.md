...
- `pp_time_and_scheduling_units.pdf`: solve-time panels on a logarithmic y-axis and scheduling-unit panels on a linear y-axis; preserve `delta` color and `Pmax` marker semantics.
