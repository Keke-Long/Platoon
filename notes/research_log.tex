...
\begin{itemize}
  ...
  \item The refined upper bound is a candidate result, not yet a final theorem.
  \item The old local-superposition propositions are rejected and should not be reused.
  \item Exhaustive small-instance verification is the next required technical step.
\end{itemize}
